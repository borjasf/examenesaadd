...
public class RepositorioPartidaMongoDB extends RepositorioMongoDB<Partida> {

	private MongoCollection<Partida> collection;
	protected MongoDatabase database;

	public RepositorioPartidaMongoDB() throws IOException {
		...
		// CAMBIAR ESTO
		collection = database.getCollection("Partidas",Partida.class)
	...
	@Override
	public MongoCollection<Partida> getCollection() {
		return collection;
	}
